#!/bin/bash
# MAE pre-training — actual full run, 2×L40S (48 GB each).
...
#
# Submit: sbatch slurm/pretrain_coco_actual_2xl40s.sh

#SBATCH --job-name=stt-mae-act-l4
#SBATCH --output=logs/mae_actual_2xl40s_%j.out
#SBATCH --error=logs/mae_actual_2xl40s_%j.err
