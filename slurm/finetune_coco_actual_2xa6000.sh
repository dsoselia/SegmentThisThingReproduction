#!/bin/bash
# Segmentation fine-tuning — actual full run, 2×RTX A6000 (48 GB each).
# 250K steps. Requires mae_coco_lr_actual/final.pth from pretrain.
#
# Submit: sbatch slurm/finetune_coco_actual_2xa6000.sh

#SBATCH --job-name=stt-seg-act-a6
#SBATCH --output=logs/seg_actual_2xa6000_%j.out
#SBATCH --error=logs/seg_actual_2xa6000_%j.err
