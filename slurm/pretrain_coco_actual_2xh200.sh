#!/bin/bash
# MAE pre-training — actual full run, 2×H200.
# 500K steps; ~144h estimated → uses --requeue to survive preemptions.
#
# Submit: sbatch slurm/pretrain_coco_actual_2xh200.sh

#SBATCH --job-name=stt-mae-act-2h
#SBATCH --output=logs/mae_actual_2xh200_%j.out
#SBATCH --error=logs/mae_actual_2xh200_%j.err
