#!/bin/bash
# MAE pre-training — actual full run, 4×H200 (fastest config).
# 500K steps; ~72h on 4×H200 at ~2 steps/sec. Uses --requeue for preemption.
#
# Submit: sbatch slurm/pretrain_coco_actual_4xh200.sh

#SBATCH --job-name=stt-mae-act-4h
#SBATCH --output=logs/mae_actual_4xh200_%j.out
#SBATCH --error=logs/mae_actual_4xh200_%j.err
