#!/bin/bash
# Segmentation fine-tuning — actual full run, 2×L40S (48 GB each).
# 250K steps. Requires mae_coco_lr_actual/final.pth from pretrain.
#
# Submit: sbatch slurm/finetune_coco_actual_2xl40s.sh

#SBATCH --job-name=stt-seg-act-l4
#SBATCH --output=logs/seg_actual_2xl40s_%j.out
#SBATCH --error=logs/seg_actual_2xl40s_%j.err
